...
public class Main {
	...
	public static <E> void main(String[] args) {
		...
		do {
			...
			System.out.println("2. Add item to LinkedList at a location");
			System.out.println("3. Remove item from LinkedList");
			System.out.println("4. Remove item from LinkedList by location");
			System.out.println("5. Retreive item from LinkedList by location");
